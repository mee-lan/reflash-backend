...
-- Teachers
-- =============================================
INSERT INTO teachers (firstname, lastname, username, password)
VALUES ('First', 'Teacher', 'username', '{noop}password');
...
VALUES (1, 'Algebra Basics',        1, DATEDIFF(SECOND, TIMESTAMP '1970-01-01 00:00:00', TIMESTAMP '2026-03-01 00:00:00')),
       (2, 'Chemistry Foundations', 2, DATEDIFF(SECOND, TIMESTAMP '1970-01-01 00:00:00', TIMESTAMP '2026-03-05 00:00:00')),
...
VALUES
  (1,  'algebra'),     (1,  'formula'),
  (2,  'algebra'),     (2,  'linear'),
  (3,  'algebra'),     (3,  'factoring'),
  (4,  'algebra'),     (4,  'binomials'),
  (5,  'thermochemistry'),
  (6,  'basic'),       (6,  'compounds'),
  (7,  'moles'),       (7,  'constants'),
  (8,  'acids'),       (8,  'bases'),
  (9,  'geometry'),    (9,  'triangles'),
  (10, 'geometry'),    (10, 'circles'),
  (11, 'geometry'),    (11, 'triangles'),
  (12, 'geometry'),    (12, 'circles'),
  (13, 'mechanics'),   (13, 'newton'),
  (14, 'constants'),   (14, 'light'),
